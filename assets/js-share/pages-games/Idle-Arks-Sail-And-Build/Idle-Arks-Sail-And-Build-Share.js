...
link.href = 'https://wa.me/?text=IDLE ARKS: SAIL AND BUILD FunGames : https://www.fungames.my.id/Pages-Games/Idle-Arks-Sail-And-Build/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=IDLE ARKS: SAIL AND BUILD FunGames : Image&url=https://www.fungames.my.id/Pages-Games/Idle-Arks-Sail-And-Build/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram
